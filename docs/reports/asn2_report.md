...
| Split   | Owner                   | Scope                                                                                          |
| ------- | ----------------------- | ---------------------------------------------------------------------------------------------- |
| Split 1 | Jeffrey Wong (`jwa334`) | Input modes & file ingestion (`-R`, `-s`, `-n`, file vs stdin)                                 |
...
| Split 4 | Ronney Lok (`rla121`)   | Transform/computation filters (`select`, `map`, `sort`, `group_by`, `unique`, `add`, `length`) |
